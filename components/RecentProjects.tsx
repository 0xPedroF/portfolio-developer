...
const RecentProjects = () => {
  ...
  return (
    <section className="relative w-full py-16" id="projects">
      <div className="section-shell space-y-10">
        ...
        <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
          {projects.map(({ id, title, des, img, link }) => (
            <article
              key={id}
              className="flex min-h-[32rem] flex-col gap-5 rounded-[28px] border border-white/10 bg-[rgba(5,7,20,0.9)] p-6 shadow-[0_25px_70px_rgba(2,6,23,0.55)] backdrop-blur-2xl"
            >
