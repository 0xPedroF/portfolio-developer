...
export const PinContainer = memo(({
  ...
  // Don't render dynamic elements during SSR to prevent hydration mismatch
  if (!isClient) {
    return (
      <div className={cn("relative z-50", containerClassName)}>
        <div className="p-4 rounded-2xl bg-black border border-white/[0.1]">
...
export const PinPerspective = memo(({
  title,
  href,
}: {
  title?: string;
