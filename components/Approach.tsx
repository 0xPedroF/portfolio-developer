...
const Card = ({
  ...
  return (
    <div
      ...
      className="group/canvas-card relative mx-auto flex w-full max-w-sm items-center justify-center rounded-3xl border border-white/10 bg-[rgba(6,9,24,0.9)] p-4 lg:h-[32rem] shadow-[0_25px_80px_rgba(2,6,23,0.55)]"
    >
